...
public class Lab10 {
    ...
    public static void Q1() {
        while (true) {
            ...
            if (!input.equals("square") && !input.equals("rectangle") && !input.equals("circle") && !input.equals("q")) {
    ...
    public static void Q2() {
        ...
        String[] suffixes = {"th", "st", "nd", "rd", "th", "th", "th", "th", "th", "th", "th"};

        if (num < 1 || num > 31) {
            System.out.println("Invalid day");
        } else {
            System.out.print("You selected " + num + suffixes[num % 100 > 10 && num % 100 < 14 ? 0 : num % 10] + " of ");
